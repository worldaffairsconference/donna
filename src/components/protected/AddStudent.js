            ...
            <Container>
              ...
              <Form onSubmit={this.handleSubmitStudent}>
                ...
                this.state.numPanelChoosen !== 4 ? (
                  ...
                  <center>
                    <button type="submit" className="btn btn-primary fonted">
                      Add Student
                    </button>
                  </center>
                )}
