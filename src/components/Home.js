      ...
      <div className="container">
        ...
        <center>
	        <div className="btn-group mr-2" role="group" aria-label="First group">
				    <a className="btn btn-primary" href="https://www.facebook.com/worldaffairsconference/">Facebook</a>
				    <a className="btn btn-primary" href="https://twitter.com/worldaffairscon">Twitter</a>
				    <a className="btn btn-primary" href="https://www.instagram.com/worldaffairscon/">Instagram</a>
				  </div>
			  </center>
      </div>
    )
